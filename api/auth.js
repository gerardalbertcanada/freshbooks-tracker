...
module.exports = (req, res) => {
  ...
  authUrl.searchParams.set('scope', 'user:profile:read user:projects:read user:time_entries:read user:bills:read user:billable_items:read user:business:read');
